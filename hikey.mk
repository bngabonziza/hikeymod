...
update_rootfs: optee-client helloworld aes-perf sha-perf strace filelist-all linux-gen_init_cpio
	cd $(GEN_ROOTFS_PATH); \
...
recovery:
	...
	$(call flash_help)
	sudo python $(ROOT)/burn-boot/hisi-idt.py -d /dev/ttyUSB1 --img1=$(LLOADER_PATH)/l-loader.bin
...
ifneq ($(FROM_RECOVERY),1)
	...
	sudo fastboot flash ptable $(LLOADER_PATH)/ptable-linux-4g.img
